...
<?php
    if (isset($_GET["id"]) && !empty($_GET["id"])) {
        ...
        if ($connUpdate->query($sqlUpdate) === TRUE) { // Record updated successfully
            echo "Reading List successfully updated!";
        } else {
...
<html lang="en">
    <head>
        ...
        <title>Book Finder - Browse Books (Topic)</title>
        <link href="styles/browse-books-styles.css" rel="stylesheet">
        <script type="text/javascript">var booksInfoPHP =<?php echo json_encode($arrayOfBooks); ?>;</script>
        <script type="text/javascript" src="scripts/browse-books-script.js"></script>
    </head>
    ...
    <body>
        ...
        <!-- Main Page -->
        <div id="main">
            <!--Title text ("Search Results for 'Judy Blume' or "Browse All Books")-->
            <div id="title-text">Showing:</div>
